...
// Own macros to replace SERVER_CLIENTS, NET_MAXGAMECOMPUTERS and NET_MAXGAMEPLAYERS
#define CORE_MAX_SERVER_CLIENTS 16
#define CORE_MAX_GAME_COMPUTERS CORE_MAX_SERVER_CLIENTS
#define CORE_MAX_GAME_PLAYERS   CORE_MAX_SERVER_CLIENTS
