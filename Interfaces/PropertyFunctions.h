...
#ifndef CECIL_INCL_PROPERTYFUNCTIONS_H
#define CECIL_INCL_PROPERTYFUNCTIONS_H
...
class IProperties {
  public:
    ...
    static inline INDEX ConvertType(CEntityProperty::PropertyType eProperty)
    {
    ...
    static inline BOOL SetPropValue(CEntity *penEntity, CEntityProperty *pep, void *pValue) {
    ...
    static inline BOOL GetPropValue(CEntity *penEntity, CEntityProperty *pep, void **pValue) {
      INDEX iPropType = ConvertType(pep->ep_eptType);
      SLONG slOffset = pep->ep_slOffset;
    ...
    static inline BOOL GetIndexValue(CEntity *penEntity, CEntityProperty *pep, INDEX &iValue) {
      void *pGetValue;
    ...
    static inline BOOL GetFloatValue(CEntity *penEntity, CEntityProperty *pep, FLOAT &fValue) {
      void *pGetValue;
      if (!GetPropValue(penEntity, pep, &pGetValue)) return FALSE;
    ...
    static inline BOOL GetStringValue(CEntity *penEntity, CEntityProperty *pep, CTString &strValue) {
      void *pGetValue;
      if (!GetPropValue(penEntity, pep, &pGetValue)) return FALSE;
    ...
    static inline BOOL GetPointerValue(CEntity *penEntity, CEntityProperty *pep, CEntity *&penValue) {
      void *pGetValue;
      if (!GetPropValue(penEntity, pep, &pGetValue)) return FALSE;
    ...
    static inline BOOL GetVectorValue(CEntity *penEntity, CEntityProperty *pep, FLOAT3D &vValue) {
      void *pGetValue;
      if (!GetPropValue(penEntity, pep, &pGetValue)) return FALSE;
