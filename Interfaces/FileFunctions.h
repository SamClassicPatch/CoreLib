...
class CORE_API IFiles {
  ...
  public:
    ...
    static CFileList aBaseWriteInc;
    static CFileList aBaseWriteExc;
    static CFileList aBaseBrowseInc;
    static CFileList aBaseBrowseExc;

  public:
    // Find any slash in a string and return its position
    static inline INDEX GetSlashPos(const char *strString) {
    ...
    static inline void SetAbsolutePath(CTFileName &fnm) {
      // Collect path parts
      CTString strRemaining(fnm);
      CStaticStackArray<CTString> astrParts;

      INDEX iSlashPos = IFiles::GetSlashPos(strRemaining);
      ...
      for (;;) {
        ...
        iSlashPos = IFiles::GetSlashPos(strRemaining);
    ...
    static inline BOOL LoadStringList(CFileList &afnm, const CTFileName &fnmList) {
      try {
        CTFileStream strm;
        strm.Open_t(fnmList);
    ...
    static inline INDEX MatchesList(const CFileList &afnm, const CTString &strPattern)
    {
    ...
    static inline void ListInDir(const CTFileName &fnmBaseDir, CFileList &afnm,
